...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ObjectSpawner : MonoBehaviour
    {
        ...
        public bool TrySpawnObject(Vector3 spawnPoint, Vector3 spawnNormal)
        {
            ...
            if (maxObjects > -1 && transform.childCount >= maxObjects)
            {
                newObject = transform.GetChild(transform.childCount - 1).gameObject;
            }
            else
            {
            ...
            var r = newObject.transform.rotation;
            r.x = 0;
            r.z = 0;
            newObject.transform.rotation = r;
